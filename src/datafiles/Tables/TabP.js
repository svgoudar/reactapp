...
class TabP extends Component 
{
 ...
 componentWillMount() {
    axios.get('https://poc100.herokuapp.com/register/pragati_table',{
      headers:{
      ...
      <table className="tab">
         ...
         <tr>
           <th className="col">Name</th>
             ...
             <th className="col">Pragati ID</th>
             <th className="col">Pragati Title</th>
...
<td className="row">{user.PragatiID}</td>
          <td className="row">{user.PragatiTitle}</td>
